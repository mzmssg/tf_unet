...
# train_data_path = "/Users/miao/Downloads/eyedata/Edema_trainingset/original_images/PC034_MacularCube512x128_12-10-2013_10-48-27_OS_sn14231_cube_z.img/2*.bmp" \
#     if platform.system()=="Darwin" \
#     else "/root/eyedata/Edema_trainingset/original_images/PC034_MacularCube512x128_12-10-2013_10-48-27_OS_sn14231_cube_z.img/20.bmp"
#
# val_data_path = "/Users/miao/Downloads/eyedata/Edema_trainingset/original_images/PC034_MacularCube512x128_12-10-2013_10-48-27_OS_sn14231_cube_z.img/2*.bmp" \
#     if platform.system()=="Darwin" \
#     else "/root/eyedata/Edema_trainingset/original_images/PC034_MacularCube512x128_12-10-2013_10-48-27_OS_sn14231_cube_z.img/20.bmp"
...
net = unet.Unet(channels=train_data_provider.channels,
                ...
                layers=3,
                features_root=16,
                cost_kwargs=dict(regularizer=0.001, class_weights=[0.269, 833, 29.8, 4.04]),
